        ...
        <nav class="flex items-center justify-between flex-wrap bg-gray-800 p-6">
            ...
            <div class="w-full block flex-grow sm:flex sm:items-center sm:w-auto">
                <div class="text-sm sm:flex-grow">
                    <a href="#" class="block mt-4 sm:inline-block sm:mt-0 text-red-200 hover:text-white mr-4">
                        Your Business
                    </a>
                    <a href="#" class="block mt-4 sm:inline-block sm:mt-0 text-red-200 hover:text-white mr-4">
                        Networking
                    </a>
                    <a href="#" class="block mt-4 sm:inline-block sm:mt-0 text-red-200 hover:text-white">
                        Blog
                    </a>
                </div>
                <div>
